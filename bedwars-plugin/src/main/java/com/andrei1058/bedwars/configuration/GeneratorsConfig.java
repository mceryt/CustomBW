...
public class GeneratorsConfig extends ConfigManager {
    ...
    public GeneratorsConfig(Plugin plugin, String name, String dir) {
        ...
        yml.addDefault("Default." + ConfigPath.GENERATOR_IRON_DELAY, 0.5);
        yml.addDefault("Default." + ConfigPath.GENERATOR_IRON_AMOUNT, 1);
        yml.addDefault("Default." + ConfigPath.GENERATOR_GOLD_DELAY, 3);
        yml.addDefault("Default." + ConfigPath.GENERATOR_GOLD_AMOUNT, 1);
        yml.addDefault("Default." + ConfigPath.GENERATOR_IRON_SPAWN_LIMIT, 120);
        yml.addDefault("Default." + ConfigPath.GENERATOR_GOLD_SPAWN_LIMIT, 12);
